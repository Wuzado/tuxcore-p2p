...
function builder(options) {
  ...
  if (!options.network) {
    options.network = garlicore.Networks.defaultNetwork;
  }

  options.Block = options.Block || garlicore.Block;
  options.BlockHeader = options.BlockHeader || garlicore.BlockHeader;
  options.Transaction = options.Transaction || garlicore.Transaction;
  options.MerkleBlock = options.MerkleBlock || garlicore.MerkleBlock;
